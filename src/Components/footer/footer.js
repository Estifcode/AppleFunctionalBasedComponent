                ...
                <section className="in-footer container ">
                    ...
                    <div className="footer-links-wrapper row"> 
                        ...
                        <div className="links-wrapper-4 col-sm-12 col-md">
                            <h3 id="business">For Business</h3>
                            <ul id="ul4">
                                <li><a href="#">Apple and Business</a></li>
                                <li><a href="#">Shop for Business</a></li>
                            </ul>		
                            <h3 id="edu">For Education</h3>
                            <ul id="ul5">
                                <li><a href="#">Apple and Education</a></li>
                                <li><a href="#">Shop for College</a></li>
                            </ul>
                            <h3 id="hel">For Healthcare</h3>
                            <ul id="ul6">
                                <li><a href="#">Manage Your Apple ID</a></li>
                                <li><a href="#">Apple Store Account</a></li>
                                <li><a href="#">iCloud.com</a></li>
                            </ul>	
                            <h3 id="gov">For Government</h3>
                            <ul id="ul7">
                                <li><a href="#">Apple and Education</a></li>
                                <li><a href="#">Shop for College</a></li>
                            </ul>
                    ...
                    <div className="copyright-wrapper row">
                        ...
                        <div classNameName="footer-links-terms col-sm-12 order-3 col-lg-6 order-lg-2">
                            <ul classNameName="row">
